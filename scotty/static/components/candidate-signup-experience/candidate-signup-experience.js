define(function(require) {
  ...
  module.controller('CandidateSignupExperienceCtrl', function($scope, $q, toaster, i18n, Loader, Session) {
    _.extend($scope, {
    ...
    function submit() {
      ...
      if (!data.length) {
        toaster.error(i18n.gettext('Please select at least one row to add.'));
        return;
      }
