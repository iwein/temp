...
module.exports = {
  ...
  files: [
    {pattern: 'features/tools/es6-promise-2.0.0.js', watched: false, included: true, served: true},
    {pattern: 'features/tools/**/*.js', watched: true, included: true, served: true},
    ...
    {pattern: 'features/world.js', watched: true, included: true, served: true},
