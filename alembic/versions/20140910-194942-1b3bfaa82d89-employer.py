...
def upgrade():
    ...
    op.create_table('employer',
                    ...
                    sa.Column('invite_sent', sa.DateTime(), nullable=True),
                    sa.Column('created', sa.DateTime(), nullable=False),
                    sa.Column('agreedTos', sa.DateTime(), nullable=True),
    ...
    op.create_table('candidate_bookmark_employer',
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('candidate_bookmark_employer')
