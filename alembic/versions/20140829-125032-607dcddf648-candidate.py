...
Revision ID: 607dcddf648
Revises: 9ddb2420d0d
Create Date: 2014-08-29 12:50:32.984000
...
def upgrade():
    ...
    sa.UniqueConstraint('candidate_id', 'skill_id', name='candidate_skill_unique')
    )
